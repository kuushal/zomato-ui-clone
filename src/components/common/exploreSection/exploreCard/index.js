...
//     const proOff = offers.lengh > 1 ? offers[0].text : null;
//     const discount = offers.length > 1 ? offers[1].text : offers.length === 1 ? offers[0].text : null;

//     return (<div className='explore-card cur-poi'>
...
//             {rating && <div className='res-rating absolute-center'>{rating}<i class="fa-solid fa-star absolute-center"></i>
//             </div>}
//             <div className='res-row'>
